    ...
    <div className="stack">
      <form
        ...
        onSubmit={async (e) => {
          ...
          setBusy(true);
          setError(null);
          const r = await createBusinessAction(form);
          if (r.ok) {
            router.replace("/home");
            router.refresh();
            return;
      ...
      >
        ...
        >
          {phone ? (
            ...
            <div className="tel">
              <span className="tel__prefix" aria-hidden="true">
                +91
              </span>
              <input
                id="you-phone"
        ...
        >
          <input
            ...
            onChange={(e) => {
              ...
              if (problem?.field === "gstin" || problem?.field === "stateCode")
                setProblem(null);
            }}
