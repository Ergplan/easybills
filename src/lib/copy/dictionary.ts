...
export const DICTIONARY = {
  ...
  'num.title': { en: 'Bill number', hi: 'Bill number' },
  'num.sub': { en: 'Next bill: {preview}', hi: 'Agla bill: {preview}' },
  'num.prefix': { en: 'Starts with', hi: 'Shuruaat (jaise INV-)' },
  'num.fy': { en: 'Put the year in it (2026-27)', hi: 'Saal bhi likhein (2026-27)' },
  'num.next': { en: 'Next number', hi: 'Agla number' },
  'num.nextHint': { en: "Can't go backwards: a number already used is never used again.", hi: 'Peeche nahi ja sakta: jo number ban chuka, woh dobara nahi lagta.' },
  'num.saved': { en: 'Saved. Next bill: {preview}', hi: 'Save ho gaya ✓ Agla bill: {preview}' },
  'num.suggest': { en: 'Your last bill was {last}. Continue from {next}?', hi: 'Aapka aakhri bill {last} tha. Agla {next} se shuru karein?' },
  'num.suggestYes': { en: 'Yes, from {next}', hi: 'Haan, {next} se' },
  'num.error.prefix': { en: 'Only letters, numbers, - and /', hi: 'Sirf letters, numbers, - aur /' },
  'num.error.tooLow': { en: 'Cannot go below {min}', hi: '{min} se kam nahi ho sakta' },
  'dup.title': { en: 'Already billed?', hi: 'Yeh bill pehle ban chuka hai?' },
  'dup.body': { en: '{number}, {date}, to the same customer, same {amount}.', hi: '{number}, {date} ko, isi customer ko, same {amount}.' },
  'dup.view': { en: 'See that bill', hi: 'Woh bill dekho' },
  'dup.anyway': { en: 'Make it anyway', hi: 'Phir bhi banao' },
  'odd.title': { en: 'Check the rate', hi: 'Rate check kar lo' },
  'odd.line': { en: '{what}: last time ₹{last}, now ₹{now}', hi: '{what}: pichli baar ₹{last}, is baar ₹{now}' },
  'odd.ok': { en: "Yes, that's right", hi: 'Haan, sahi hai' },
  'owing.note': { en: '{name} already owes {amount}.', hi: '{name} ke {amount} pehle se baaki hain.' },
  'bill.resumed': { en: 'Picked up the bill you had started.', hi: 'Aapka adhoora bill wahi khol diya.' },
  'fix.title': { en: 'Made a mistake?', hi: 'Galti ho gayi?' },
  'fix.redo': { en: 'Cancel and redo', hi: 'Cancel karke naya banao' },
  'fix.redoHint': { en: 'This bill is cancelled (its number stays used) and a new one opens with the same lines.', hi: 'Yeh bill cancel hoga (number waisa hi rahega, dobara nahi lagega) aur wahi lines ke saath naya bill khulega.' },
  'fix.redoBlocked': { en: 'Money has come in against it, so it cannot be cancelled. Reduce the amount instead.', hi: 'Paise aa chuke hain, isliye cancel nahi. Rakam kam karo.' },
  'fix.reason': { en: 'Why?', hi: 'Kyun?' },
  'fix.reasonHint': { en: 'e.g. wrong rate, wrong customer', hi: 'jaise: rate galat, customer galat' },
  'fix.less': { en: 'Reduce the amount', hi: 'Rakam kam karo' },
  'fix.lessHint': { en: 'A credit note is made (CN-001) and the bill comes down by that much, GST included.', hi: 'Credit note banega (CN-001), bill ki rakam utni kam ho jaayegi, GST bhi usi hisaab se.' },
  'fix.lessAmount': { en: 'Reduce by (₹)', hi: 'Kitna kam (₹)' },
  'fix.lessDone': { en: 'Credit note {number} made. {amount} still to come.', hi: 'Credit note {number} ban gaya. Ab {amount} baaki.' },
  'fix.cancelled': { en: 'Cancelled', hi: 'Cancel kiya' },
  'fix.cancelledOn': { en: 'Cancelled {date} · {reason}', hi: '{date} ko cancel · {reason}' },
  'fix.redoneAs': { en: 'Redone as {number}', hi: 'Naya bill: {number}' },
  'fix.notes': { en: 'Credit notes', hi: 'Credit notes' },
  'year.title': { en: 'New financial year: {fy}', hi: 'Naya saal shuru: {fy}' },
  'year.body': { en: 'Bill numbers start from 1 again; "{prefix}" stays as it is.', hi: 'Bill number phir 1 se shuru hoga, "{prefix}" waise hi rahega.' },
  'year.go': { en: 'OK, start', hi: 'Shuru karo' },
  'bills.cancelled': { en: 'Cancelled', hi: 'Cancel kiye bills' },
  'gst.cancelled': { en: '{n} cancelled this quarter ({numbers}). Tell your CA.', hi: 'Is quarter {n} bill cancel kiye ({numbers}). CA ko bata dena.' },
  ...
  'voice.hint': { en: 'Say "Mehta Traders ka bill, AMC visit 3500" or "kiske paise aane hain"', hi: 'Bolo "Mehta Traders ka bill, AMC visit 3500" ya "kiske paise aane hain"' },
  'voice.consent': { en: 'Your voice goes to OpenAI to be understood. The bill is still made by your tap.', hi: 'Aapki awaaz samajhne ke liye OpenAI ko jaati hai. Bill phir bhi aapke tap se hi banta hai.' },
  'voice.off': { en: 'Voice is not switched on for this app yet.', hi: 'Bolke karna abhi chalu nahi hai.' },
  'voice.noMic': { en: "Couldn't use the microphone. Allow it in the browser and try again.", hi: 'Mic nahi mila. Browser mein allow karke dobara try karo.' },
  'voice.failed': { en: 'Could not connect. Try again.', hi: 'Connect nahi hua. Dobara try karo.' },
  'voice.you': { en: 'You', hi: 'Aap' },
  'voice.app': { en: 'EkBill', hi: 'EkBill' },
  'voice.opening': { en: 'Opening the bill', hi: 'Bill khol rahe hain…' },
  'voice.unknownCustomer': { en: 'No customer called "{name}" yet', hi: '"{name}" naam ka customer abhi nahi hai' },
  'voice.prefilled': { en: 'Filled in from what you said. Check, then Bill banao.', hi: 'Aapke bole se bhar diya. Dekh lo, phir Bill banao.' },
